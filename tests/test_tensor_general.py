from .strategies import checked_grad
import random
...
def test_two_grad_broadcast(
    ...
    checked_grad(tensor_fn, t1.sum(0), t2)
    checked_grad(tensor_fn, t1, t2.sum(0))
